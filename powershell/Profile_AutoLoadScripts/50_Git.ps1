...
# Don't do anything here if posh-git is imported.
if (Get-Module "posh-git") {
    Write-Debug "Skipping git functions as posh-git is already installed."
    return
}
...
function Invoke-Git {
    ...
    # Invoke the git command as a cmd.exe command because git has this habit of
